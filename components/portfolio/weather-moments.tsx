...
const moments: Record<WeatherMode, { label: string; title: string; detail: string; time: string }> = {
  clear: {
    label: "Clear sky",
...
function RainIcon() {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" focusable="false">
      <path d="M13 29h23a8 8 0 0 0 0-16 12 12 0 0 0-23 4 6 6 0 0 0 0 12Z" />
      <path d="m17 36-2 5M25 36l-2 5M33 36l-2 5" />
    </svg>
  );
}
...
function AfterglowIcon() {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" focusable="false">
      <path d="M8 31h32M12 31a12 12 0 0 1 24 0M24 8v6M10.2 14.2l4.2 4.2M37.8 14.2l-4.2 4.2" />
      <path d="M8 38h32" />
    </svg>
  );
}
  ...
  return (
    <section className={`weather-moments weather-${mode}`} aria-labelledby="weather-title">
      <div className="weather-copy">
        <p className="eyebrow">A small visual study</p>
        <h2 id="weather-title">Weather moments.</h2>
        <p>
          A quiet interaction inspired by changing skies: the same work can feel different
      ...
      <div className="weather-scene" aria-live="polite">
        <span className="weather-time">{moment.time} / KIANDAS SKY</span>
